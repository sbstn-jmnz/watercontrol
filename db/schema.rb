...
ActiveRecord::Schema.define(version: 20160428204311) do
  ...
  create_table "admins_condos", id: false, force: :cascade do |t|
    t.integer "admin_id"
    t.integer "condo_id"
  end
  ...
  add_index "users", ["condo_id"], name: "index_users_on_condo_id", using: :btree
